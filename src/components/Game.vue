  ...
  <div id="app">
    <div class="container-fluid">
      <div>
        <div class="row">
           <div class="col">
          <p id="tufft">We have selected a random number between 1 and 100. See if you can guess it in 10 turns or fewer. We'll tell you if your guess was too high or too low.</p>
            <div class="col">
               <button class="button" @click="startGame" v-on:click="game = !game">Start Game</button><br><br>
                <div v-show="game">
