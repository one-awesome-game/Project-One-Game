...
<div class="wrapper">
 ...
 <div class="container">
    <div class="row">
      <div class="col s12 m8 offset-m2"><br><br>
...
.login{
  ...
  background: url('https://images.unsplash.com/photo-1511268011861-691ed210aae8?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60') no-repeat;
...
.snow{
  ...
  overflow: hidden;
  height: 100vh;
  background: url('https://images.unsplash.com/photo-1513885535751-8b9238bd345a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80') no-repeat center fixed;
  background-size: cover;
}
