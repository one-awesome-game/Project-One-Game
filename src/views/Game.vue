...
.game {
  ...
  background-color: rgba(233, 56, 90, 0.7);
}
...
.över {
  ...
  width: auto;
  height: 500px;
  background-color: rgba(233, 56, 90, 1);


}

::selection {
  background: rgba(233, 56, 90, 1);
}
...
@font-face {
  ...
  font-style: normal;
  src: local("Mountains of Christmas"), local("MountainsofChristmas-Regular"), url() format("woff2"); }
.message {
  position: absolute;
  left: 50%;
  top: 50%;
